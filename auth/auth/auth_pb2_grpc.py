...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Login = channel.unary_unary(
                '/AuthService/Login',
                request_serializer=auth__pb2.Payload.SerializeToString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Login': grpc.unary_unary_rpc_method_handler(
                    servicer.Login,
                    request_deserializer=auth__pb2.Payload.FromString,
...
class AuthService(object):
    ...
    def Login(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AuthService/Login',
            auth__pb2.Payload.SerializeToString,
    ...
    def Refresh(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AuthService/Refresh',
    ...
    def CheckToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AuthService/CheckToken',
            auth__pb2.JWTToken.SerializeToString,
            auth__pb2.Payload.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
